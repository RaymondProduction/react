...
var _MessageForm = __webpack_require__(46);
...
var phones = [{ id: 1, name: "iPhone 7" }, { id: 2, name: "Google Pixel" }, { id: 3, name: "HTC U Ultra" }];
...
var Tablet = function (_React$Component5) {
    _inherits(Tablet, _React$Component5);
...
var ProductsId = function (_React$Component6) {
    _inherits(ProductsId, _React$Component6);

    function ProductsId() {
        _classCallCheck(this, ProductsId);

        return _possibleConstructorReturn(this, (ProductsId.__proto__ || Object.getPrototypeOf(ProductsId)).apply(this, arguments));
    }

    _createClass(ProductsId, [{
        key: 'render',
        value: function render() {
            return _react2.default.createElement(
                'h2',
...
var Products = function (_React$Component7) {
    _inherits(Products, _React$Component7);
    ...
    _createClass(Products, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    _reactRouterDom.NavLink,
                    { exact: true, to: '/products/phones', style: style, activeStyle: active },
                    'Phones'
                ),
                _react2.default.createElement(
                    _reactRouterDom.NavLink,
                    { to: '/products/tablets', style: style, activeStyle: active },
                    'Tablets'
                )
            );
        }
    ...
    _createClass(Nav, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    _reactRouterDom.NavLink,
                    { exact: true, to: '/', style: style, activeStyle: active },
                    'Main'
                ),
                _react2.default.createElement(
                    _reactRouterDom.NavLink,
                    { to: '/about', style: style, activeStyle: active },
                    'About'
                ),
                _react2.default.createElement(
                    _reactRouterDom.NavLink,
                    { to: '/products', style: style, activeStyle: active },
                    'Products'
                )
            );
        }
...
_reactDom2.default.render(_react2.default.createElement(
    ...
    _react2.default.createElement(
        ...
        _react2.default.createElement(
            ...
            null,
            _react2.default.createElement(_reactRouterDom.Route, { exact: true, path: '/:id(\\d+)', component: Main }),
            _react2.default.createElement(_reactRouterDom.Route, { path: '/about/:id?/:name?', component: About }),
            _react2.default.createElement(_reactRouterDom.Route, { path: '/products/:id(\\d+)', component: ProductsId }),
            _react2.default.createElement(_reactRouterDom.Route, { exact: true, path: '/products', component: Products }),
            _react2.default.createElement(_reactRouterDom.Route, { path: '/products/phones', component: PhoneList }),
            _react2.default.createElement(_reactRouterDom.Route, { path: '/products/tablets', component: Tablet }),
            _react2.default.createElement(_reactRouterDom.Route, { path: '/contact', children: function children() {
                    return _react2.default.createElement(
                        'h2',
                        null,
                        'Contact'
            ...
            _react2.default.createElement(_reactRouterDom.Redirect, { from: '/', to: '/0' }),
...
var MessageField = function (_React$Component) {
  ...
  function MessageField(props) {
    ...
    var isValid = _this.validate(props.value);
    _this.state = { value: props.value, valid: isValid };
  ...
  _createClass(MessageField, [{
    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        React.createElement("input", { type: "text", value: this.state.value, onChange: this.onChange, style: { borderColor: color } })
      );
    }
  }]);
...
var TitleField = function (_React$Component2) {
  _inherits(TitleField, _React$Component2);

  function TitleField(props) {
    _classCallCheck(this, TitleField);

    var _this2 = _possibleConstructorReturn(this, (TitleField.__proto__ || Object.getPrototypeOf(TitleField)).call(this, props));

    var isValid = _this2.validate(props.value);
    _this2.state = { value: props.value, valid: isValid };
...
var MessageForm = function (_React$Component3) {
  ...
  _createClass(MessageForm, [{
    ...
    value: function handleSubmit(e) {
      ...
      if (this.refs.messageField.state.valid && this.refs.titleField.state.valid) alert("Title: " + title + " Message: " + message);
    }
  }, {
    key: "render",
    value: function render() {
      return React.createElement(
        ...
        React.createElement(TitleField, { value: "Title", ref: "titleField" }),
        React.createElement(MessageField, { value: "Message", ref: "messageField" }),
